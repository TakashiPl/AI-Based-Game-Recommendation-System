#Function to check whether the number provided for us age is a number and is a certain type (default = int)
...
#Function to check whether the string is not empty
